            ...
            <div className="pt-1 lg:pt-0  px-4 xs:px-6 sm:px-0 md:w-3/4 h-full ">
                ...
                <div className="">
                    ...
                    <div className="py-6 lg:px-8 rounded">
                        ...
                        {/* Carts */}
                        <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 2xl:grid-cols-2 gap-4">
                            ...
                            <div className=" md:cursor-pointer">
                                ...
                                <div className=" px-4 2xl:px-8 space-y-4 pt-10 shadow-md rounded-b-sm md:rounded-b-md">
                                    <div className="flex justify-between xl:pr-3">
                                        ...
                                        <button className="w-max h-full rounded-sm md:rounded hover:bg-color6 hover:text-white focus:bg-color6 focus:text-white py-1 px-3 xl:px-4 2xl:py-1.5 text-color5 text-sm border-2 border-color6 outline-none focus:outline-none">Expired</button>
                                    </div>
                                    <div className="flex flex-wrap gap-3 xs:gap-4 text-color5">
                                        ...
                                        <div className="text-sm flex space-x-1 2xl:space-x-2">
                                            ...
                                            <h3 className="text-xs 2xl:text-lg my-auto">House</h3>
                                        </div>
                                    </div>
                                    <div className=" flex justify-between py-2 2xl:py-4 border-t border-color5 border-opacity-30">
                                        ...
                                        <div className="flex space-x-2">
                                            <img className="cursor-pointer hover:opacity-50 w-8 2xl:w-max" src="AllAd/Group 8961.svg" />
                                            <img className="cursor-pointer hover:opacity-50 w-8 2xl:w-max" src="AllAd/Group 8962.svg" />
                                            <img className="cursor-pointer hover:opacity-50 w-20 2xl:w-max" src="AllAd/Group 8985.svg" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className=" md:cursor-pointer">
                                ...
                                <div className=" px-4 2xl:px-8 space-y-4 pt-10 shadow-md rounded-b-sm md:rounded-b-md">
                                    <div className="flex justify-between xl:pr-3">
                                        ...
                                        <button className="w-max h-full rounded-sm md:rounded hover:bg-color5 hover:text-white focus:bg-color5 focus:text-white py-1 px-3 xl:px-4 2xl:py-1.5 text-color5 text-sm border-2 border-color5 outline-none focus:outline-none">Active</button>
                                    </div>
                                    <div className="flex flex-wrap gap-3 xs:gap-4 text-color5">
                                        <div className="text-sm flex space-x-1 2xl:space-x-2">
                                            <img className=" mr-1 w-4 xs:w-5 2xl:w-max" src="HomePage5/Vector.svg" />
                                        ...
                                        <div className="text-sm flex space-x-1 2xl:space-x-2">
                                            <img className=" mr-1 w-3 xs:w-5 2xl:w-5" src="HomePage5/Group 9990.svg" />
                                            <h3 className="text-xs 2xl:text-lg my-auto">Townhouse</h3>
                                        </div>
                                    </div>
                                    <div className=" flex justify-between py-2 2xl:py-4 border-t border-color5 border-opacity-30">
                                        <div className="text-color5 text-sm 2xl:text-xl my-auto">For Buy</div>
                                        <div className="flex space-x-2">
                                            <img className="cursor-pointer hover:opacity-50 w-20 2xl:w-max" src="AllAd/Group 8984.svg" />
                                            <img className="cursor-pointer hover:opacity-50 w-8 2xl:w-max" src="AllAd/Group 8961.svg" />
                                            <img className="cursor-pointer hover:opacity-50 w-8 2xl:w-max" src="AllAd/Group 8962.svg" />
                                        </div>
                                    </div>
                            ...
                            <div className=" md:cursor-pointer">
                                ...
                                <div className=" px-4 2xl:px-8 space-y-4 pt-10 shadow-md rounded-b-sm md:rounded-b-md">
                                    ...
                                    <div className="flex flex-wrap gap-3 xs:gap-4 text-color5">
                                        ...
                                        <div className="text-sm flex space-x-1 2xl:space-x-2">
                                            <img className=" mr-1 w-3 xs:w-5 2xl:w-5" src="HomePage5/Group 9990.svg" />
                                            <h3 className="text-xs 2xl:text-lg my-auto">End of Terrace..</h3>
                                        </div>
                                    </div>
                                    <div className=" flex justify-between py-2 2xl:py-4 border-t border-color5 border-opacity-30">
                                        <div className="text-color5 text-sm 2xl:text-xl my-auto">For Buy</div>
