                ...
                <div className="2xl:pt-10 w-full h-full md:flex">
                    ...
                    <div className="md:mt-0.5 pt-1 xs:pt-1.5 md:pt-0 w-full md:w-1/3 grid grid-cols-4 md:grid-cols-1 gap-1 xs:gap-1.5 md:gap-0">
                        <div className=" cursor-pointer w-full md:px-1">
                            <img className="w-full object-cover rounded-sm md:rounded-none md:rounded-tr" src="HomePage5/Rectangle 2681.svg" />
                        </div>

                        <div className=" cursor-pointer w-full md:px-1">
                            <img className="w-full object-cover rounded-sm md:rounded-none" src="HomePage5/Rectangle 2681.svg" />
                        </div>

                        <div className=" cursor-pointer w-full md:px-1">
                            <img className="w-full object-cover rounded-sm md:rounded-none md:rounded-br" src="HomePage5/Rectangle 2681.svg" />
                        </div>
                            ...
                            <div className="py-4 sm:px-8 md:pt-8 2xl:px-12 2xl:pt-12   ">
                                ...
                                <div className="pb-5 sm:pb-10 2xl:pb-16 flex flex-wrap gap-3 xs:gap-4 md:gap-8 xl:gap-10 2xl:gap-16 text-color5">
                                    <div className="text-sm flex space-x-1 md:space-x-4 2xl:space-x-6">
                                        <img className=" mr-1 w-4 xs:w-5 md:w-6 2xl:w-8" src="HomePage5/Vector.svg" />
                                        <h3 className="text-xs md:text-sm 2xl:text-2xl 2xl:font-normal font-medium my-auto">6 Bed</h3>
                                    </div>
                                    <div className="text-sm flex space-x-1 md:space-x-4 2xl:space-x-6">
                                        <img className=" mr-1 w-4 xs:w-5 md:w-6 2xl:w-8" src="HomePage5/Layer_1.svg" />
                                        <h3 className="text-xs md:text-sm 2xl:text-2xl 2xl:font-normal font-medium my-auto">3 Baths</h3>
                                    </div>
                                    <div className="text-sm flex space-x-1 md:space-x-4 2xl:space-x-6">
                                    ...
                                    <div className="text-sm flex space-x-1 md:space-x-4 2xl:space-x-6">
                                        <img className=" mr-1 w-3 xs:w-4 md:w-6 2xl:w-7" src="HomePage5/Group 10383.svg" />
                                        <h3 className="text-xs md:text-sm 2xl:text-2xl 2xl:font-normal font-medium my-auto">Apartment</h3>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className=" space-y-5 sm:space-y-0 text-sm md:text-base 2xl:text-xl text-color5  sm:flex ">
                                    ...
                                    <div className="space-y-5 sm:w-1/2">
                                        <div className="w-full flex ">
                                            <h3 className="w-1/2 sm:w-52 font-medium">Bed :</h3>
                                            <h3 className="w-1/2 sm:w-52">6</h3>
                                        </div>

                                        <div className="w-full flex">
                                            <h3 className="w-1/2 sm:w-52 font-medium">Bath :</h3>
                                            <h3 className="w-1/2 sm:w-52">4</h3>
                                        </div>
