    ...
    return (
        <div className="pt-32 sm:pt-32 2xl:pt-36">
            ...
            <div className="hidden md:block xl:pt-5 px-4 xs:px-6 sm:px-8 lg:px-20">
                <h3 className="sm:hidden pb-5 md:text-xl lg:text-2xl font-bold text-color5 ">Parking For Sale</h3>
                {/* search */}
                ...
                <h3 className=" py-4  md:text-left md:pb-10 md:text-xl lg:text-2xl font-bold text-color5 ">6 Parking Spaces For Sale in Ireland</h3>
            </div>
