...
const CommercialLease = ({ onScroll }) => {
    ...
    return (
        <div className="pt-32 sm:pt-32 2xl:pt-36">
            ...
            <div className=" px-4 xs:px-6 sm:px-8 lg:px-20  pb-10 md:flex md:space-x-4">
...

                {
                    ...
                    <div className="md:hidden h-full w-full sm:w-1/2 md:w-1/3 lg:w-1/3 rounded sm:rounded-lg bg-color5">
                        ...
                        <div className=" px-7 xs:px-10 md:px-4 lg:px-4 2xl:px-6 pb-14">
                            ...
                            {/* For Sale  / To Lease */}
                            <div className="pt-8">
                                <div className="flex justify-center py-3  gap-4 border-2 border-color19 rounded-sm ">
                                    <div class="flex items-start ">
                                        <div class="flex items-center h-5">
                                            <input id="remember" aria-describedby="remember" type="checkbox" class="w-5 h-5 md:w-4 md:h-4 bg-color5 checked:bg-color1  " required="" />
                                        </div>
                                        <div class="ml-2 2xl:ml-3 text-sm">
                                            <label for="remember" class="text-white dark:text-gray-300">For Sale</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-start ">
                                        ...
                                        <div class="ml-2 2xl:ml-3 text-sm">
                                            <label for="remember" class="text-white dark:text-gray-300">To Lease</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="py-4">
                                ...
                                <div className=" space-y-4 2xl:space-y-4 ">
                                    ...
                                    <div class="flex items-start ">
                                        ...
                                        <div class="ml-2 2xl:ml-3 text-sm">
                                            <label for="remember" class="text-white dark:text-gray-300">Office Space</label>
                                        </div>
                                    </div>
                                    <div class="flex items-start ">
                                        <div class="flex items-center h-5">
                                        ...
                                        <div class="ml-2 2xl:ml-3 text-sm">
                                            <label for="remember" class="text-white dark:text-gray-300">Retail Unit </label>
                                        </div>
                                    </div>
                                    <div class="flex items-start ">
                                        <div class="flex items-center h-5">
                                        ...
                                        <div class="ml-2 2xl:ml-3 text-sm">
                                            <label for="remember" class="text-white dark:text-gray-300">Industrial Unit</label>
                                        </div>
                                    </div>
                                    <div class="flex items-start ">
                                        <div class="flex items-center h-5">
                                        ...
                                        <div class="ml-2 2xl:ml-3 text-sm">
                                            <label for="remember" class="text-white dark:text-gray-300">Restaurant/Bar/Hotel</label>
                                        </div>
                                    </div>
                                    <div class="flex items-start ">
                                        <div class="flex items-center h-5">
                                        ...
                                        <div class="ml-2 2xl:ml-3 text-sm">
                                            <label for="remember" class="text-white dark:text-gray-300">Commercial Site</label>
                                        </div>
                                    </div>
                                    <div class="flex items-start ">
                                        <div class="flex items-center h-5">
                                        ...
                                        <div class="ml-2 2xl:ml-3 text-sm">
                                            <label for="remember" class="text-white dark:text-gray-300">Agricultural Land</label>
                                        </div>
                                    </div>
                                    <div class="flex items-start ">
                                        <div class="flex items-center h-5">
                                        ...
                                        <div class="ml-2 2xl:ml-3 text-sm">
                                            <label for="remember" class="text-white dark:text-gray-300">Industrial Site</label>
                                        </div>
                                    </div>
                                    <div class="flex items-start ">
                                        <div class="flex items-center h-5">
                                        ...
                                        <div class="ml-2 2xl:ml-3 text-sm">
                                            <label for="remember" class="text-white dark:text-gray-300">Office Share</label>
                                        </div>
                                    </div>
                                    <div class="flex items-start ">
                                        <div class="flex items-center h-5">
                                        ...
                                        <div class="ml-2 2xl:ml-3 text-sm">
                                            <label for="remember" class="text-white dark:text-gray-300">Development Land</label>
                                        </div>
                                    </div>
                ...
                <div className="hidden md:block h-full w-full sm:w-1/2 md:w-1/3 lg:w-1/3 ">

                    <div className="rounded sm:rounded-lg bg-color5">
                    ...
                    <div className="mt-16 space-y-4">
                        <div>
                            <img className=" shadow-xl rounded-lg" src="HomePage5/new/image 17.svg" />
                        </div>
                        <div>
                            <img className=" shadow-xl rounded-lg" src="HomePage5/new/image 17.svg" />
                        </div>
                        ...
                        <div className=" md:cursor-pointer">
                            <div className="">
                                ...
                                <div className="relative  -mt-14 ml-4 2xl:-mt-16 2xl:ml-6 w-max px-3 py-1.5 2xl:py-2.5 rounded text-white font-medium bg-color1">
                                    <span className="2xl:text-xl">€5,150</span>
